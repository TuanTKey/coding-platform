            ...
            <View style={styles.featuresGrid}>
              {adminFeatures.map((feature, index) => (
                <TouchableOpacity
                  ...
                  onPress={() => router.replace(feature.route)}
                  activeOpacity={0.9}
                >
                  <LinearGradient
...
function QuickStats() {
  ...
  if (loading) {
    return (
      <View style={styles.quickStats}>
        <View style={styles.statCard}><Text style={styles.statLabel}>Đang tải...</Text></View>
        <View style={styles.statCard}><Text style={styles.statLabel}>Đang tải...</Text></View>
        <View style={styles.statCard}><Text style={styles.statLabel}>Đang tải...</Text></View>
      </View>
    );
  ...
  if (error) {
    return (
      <View style={styles.quickStats}>
        <View style={styles.statCard}><Text style={styles.statLabel}>{error}</Text></View>
      </View>
    );
  }
  return (
