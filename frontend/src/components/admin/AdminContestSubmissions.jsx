...
const AdminContestSubmissions = () => {
  ...
  const fetchContests = async () => {
    try {
      ...
      setContests([
        { _id: "all", title: "Tất cả cuộc thi" },
        ...(response.data.contests || response.data || []),
      ]);
    } catch (error) {
  ...
  const exportToExcel = () => {
    ...
    link.setAttribute(
      "download",
      `bai_thi_${new Date().toISOString().split("T")[0]}.csv`
    );
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            >
              {filteredData.length} bài nộp •{" "}
              {new Set(filteredData.map((s) => s.user?._id)).size} học sinh
            </p>
          </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">
                          {selectedSubmission.contestId?.title || "N/A"}
                        </span>
                      </div>
                      <div className="flex justify-between">
